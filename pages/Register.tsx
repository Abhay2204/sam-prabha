    ...
    <div className="min-h-screen pt-28 pb-20 flex items-center justify-center px-6">
      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 md:p-10">
          ...
          <button
            disabled
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-gray-100 border-2 border-gray-200 rounded-lg font-medium text-gray-400 cursor-not-allowed"
          >
